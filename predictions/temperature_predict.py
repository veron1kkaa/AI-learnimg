...
# Load the data
df = pd.read_csv(r"C:\Users\ACER\PycharmProjects\AILearning\datasets\river_flow.csv")
...
model = keras.Sequential([
    keras.layers.LSTM(50, activation='relu', return_sequences=True, input_shape=(look_back, 1)),
...
plt.plot(future_dates, future_forecost, label="30 днів")
plt.legend()
plt.show()